                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="attr-detail attr-size mb-30">
                                    ...
                                    <select class="form-control unicase-form-control" name="" id="dsize" required>
                                ...
                                <div class="attr-detail attr-size mb-30">
                                    ...
                                    <select class="form-control unicase-form-control" name="" id="dcolor" required>
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    ...
                                    <ul class="contact-infor mb-50">
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg')}}" alt="" /><strong>Address: </strong> <span>Owner Address</span></li>
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Contact Seller: </strong><span>Owner Mobile Phone</span></li>
                                    </ul>

                                    <p>Owner Short Information </p>
                                    @else
                                    <ul class="contact-infor mb-50">
