                        ...
                        <div class="card-body">
                         <form id="myForm" method="POST" action="{{ route('update.banner') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <input type="text" name="banner_url" class="form-control" value="{{ $banners->banner_url }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ asset($banners->banner_image) }}" alt="Admin"  width="100px ; height:100px;">
                                </div>
                            </div>
