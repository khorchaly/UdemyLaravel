            ...
            <div class="row">
               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="product_size" class="form-control visually-hidden" data-role="tagsinput" value="small size,medium size,large size">
                </div>
                ...
                <div class="form-group mb-3">
                    <label for="inputProductDescription" class="form-label">Long Description</label>
                       <textarea class="form-control" name="long_descp" id="inputProductDescription" rows="3"></textarea>
                </div>
