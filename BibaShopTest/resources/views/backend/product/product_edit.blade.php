               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="form-group mb-3">
                    <label for="inputProductDescription" class="form-label">Long Description</label>
                       <textarea class="form-control" name="long_descp" id="inputProductDescription" rows="3">{{ $products->long_descp }}</textarea>
                </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-12">
                        ...
                        <select name="category_id" class="form-select" id="inputVendor">
                            ...
                            <option value="{{ $categorie->id }}" {{ $categorie->id == $products->category_id ? "selected" : '' }}>{{ $categorie->category_name }}</option>
